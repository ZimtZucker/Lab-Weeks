...
function makesquares() {
  ...
  canvas2.fill(255, 51, 51);
  canvas2.ellipse(600, 40, -70, 70);
  canvas2.fill(153, 255,102 );
  canvas2.ellipse(600, 110, -70, 70);
  canvas2.fill(51, 153, 255);
  canvas2.ellipse(600, 180, -70, 70);
  canvas2.fill(0, 0, 0);
  canvas2.ellipse(600, 250, -70, 70);
  canvas2.stroke(255, 255, 255);
  canvas2.strokeWeight(10);
  canvas2.line(width - 20, 215, width - 60, 270);
}